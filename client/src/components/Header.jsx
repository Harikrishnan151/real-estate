  ...
  return (
    <header className='bg-slate-200 shadow-md'>
        ...
        <form onSubmit={handleSubmit} className='bg-slate-100 p-3 rounded-lg flex items-center' >
            ...
            <button>
            <FaSearch className='text-slate'/>
            </button>    
        </form>
        <ul className='flex gap-6'>
          <Link to='/'> <li className='hidden sm:inline text-slate-700 hover:underline sm:text-xl'> Home</li> </Link> 
          <Link to='/about'> <li className='hidden sm:inline text-slate-700 hover:underline sm:text-xl'>About</li> </Link>
       ...
       <Link to='/profile'>
            {currentUser ? (
              ...
              <li className=' text-slate-700 hover:underline sm:text-xl'> Sign In</li>
            )}
          </Link>
        </ul>
